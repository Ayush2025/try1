...
export function SimpleAR({ 
  ...
  const initializeAR = () => {
    ...
    const tryInit = () => {
      ...
      console.log("Initializing 3D scene for:", selectedModel);

    // Create scene directly with A-Frame
    containerRef.current.innerHTML = `
      ...
      >
        ...
        <a-entity position="0 0 -3" id="model-container">
    ...
    setTimeout(() => {
      ...
      if (scene) {
        ...
        toast({
          ...
          description: `${selectedModel} is ready to explore`,
        });
      } else {
  ...
  const loadAFrame = () => {
    ...
    script.onload = () => {
      console.log("A-Frame loaded, initializing scene");
      setTimeout(() => {
        initializeAR();
      }, 1000);
    };
    ...
    return (
      <div className="fixed inset-0 bg-black z-50 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-gray-300">Preparing {selectedModel} visualization...</p>
        </div>
      </div>
    );
  }
